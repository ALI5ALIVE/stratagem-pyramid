...
const ACTS = [
  ...
  { id: "act5", text: "On the frontline. The same operating model, threading every decision. Time-to-resolve drops by around seventy percent. Coordination cost falls by a third. And teams act on three times more signals before they become incidents. These figures are modelled, not measured. Not a faster silo. A different operation." },
