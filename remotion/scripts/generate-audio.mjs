...
const ACTS = [
  ...
  { id: "act2", text: "We built four silos to keep operations safe. Safety. Operations. Technical. Compliance. Each one is brilliant on its own. None of them talk. About sixty-five percent of operational signals never make it home. The industry carries twenty-five to thirty-five billion dollars in avoidable annual exposure. And generic A I? It gets the domain right about thirty-five percent of the time. This isn't a tooling problem. It's an architecture problem." },
  ...
  { id: "act5", text: "On the frontline. On the flight deck. In the control room. The same operating model, threading every decision. Domain accuracy lifts from around thirty-five percent — to roughly ninety, at levels four and five. Not a faster silo. A different operation." },
