...
const ACTS = [
  ...
  { id: "act2", text: "We built three silos to keep operations safe. Safety. Content. Training. Each one is brilliant on its own. None of them talk. Around forty percent of operational reports have no documented closure within ninety days. The industry carries a twenty-five to thirty-five billion dollar addressable controllable-cost envelope — modelled bottom-up from per-operator baselines. And today, a typical cross-silo signal takes two to four weeks to move from signal to decision. The operation is reacting to events, not controlling them. This isn't a tooling problem. It's an architecture problem." },
  ...
  { id: "act5", text: "On the frontline. On the flight deck. In the control room. The same operating model, threading every decision. Time-to-resolve drops by around seventy percent. Coordination cost falls by a third. And teams act on three times more signals before they become incidents. These figures are modelled, not measured — held lightly enough to revise. Not a faster silo. A different operation." },
