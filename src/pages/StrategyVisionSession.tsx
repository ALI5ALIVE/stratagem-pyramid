...
const customerAttendees = visionSessionAttendees.filter((a) => !a.toLowerCase().includes("comply365"));
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden border-b border-border/40">
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-10 pt-20 pb-24 lg:pt-28 lg:pb-32">
          <div className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-primary font-semibold mb-6">
            ...
            Complimentary · 3 hours · On-site or virtual
          </div>
          ...
          <p className="mt-6 text-lg md:text-2xl text-foreground/75 max-w-3xl leading-snug">
            Three hours that move the conversation from tickets and renewals to where your operation will
            be in twelve months.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
        ...
        <div className="space-y-5 text-lg text-foreground/80 leading-relaxed">
          <p>
            ...
            doesn't get answered in a feature demo or a ticket queue.
          </p>
          <p>
      ...
      <section className="max-w-5xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
        ...
        <p className="text-lg text-foreground/70 max-w-2xl mb-12">
          Most operators we meet sit at L2 or early L3. L4 is where Operational Data starts predicting,
          not just describing.
        </p>
      ...
      <section className="border-y border-border/40 bg-card/30">
        <div className="max-w-5xl mx-auto px-6 lg:px-10 py-20 lg:py-24">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight max-w-3xl mb-4">
            The room matters more than the agenda.
          </h2>
          <p className="text-lg text-foreground/70 max-w-2xl mb-10">
            This session works best with the people who can actually commit to direction — not just
            operators reporting back later.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            {customerAttendees.map((a) => (
              <div
                key={a}
                className="p-4 rounded-xl border border-border bg-background/60 flex items-center gap-3"
              >
            ...
            <div className="p-4 rounded-xl border border-dashed border-primary/40 bg-primary/5 flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-primary/20 border border-primary/40 flex items-center justify-center">
                <Sparkles className="h-4 w-4 text-primary" />
              </div>
              <span className="font-medium text-sm">Comply365 strategist + solutions engineer</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {visionSessionLeaveBehind.map((item, i) => {
            ...
            return (
              <div
                key={item}
                className="p-7 rounded-2xl border border-border bg-card/40 hover:border-primary/40 transition-colors"
              >
                <div className="h-11 w-11 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center mb-5">
