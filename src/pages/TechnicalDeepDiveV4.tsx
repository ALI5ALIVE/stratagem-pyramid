...
const slides = [
  ...
  { id: "tech-slide-tiers-vs-ai", label: "L2 · Tiers vs Generic AI", component: TechSlideTiersVsAI },
  // Mobile
  { id: "tech-divider-mobile", label: "▸ Layer 3 · Unified Mobile", component: TechSlideLayerDivider, dividerProps: dividerProps.mobile },
  { id: "tech-slide-mobile", label: "L3 · Unified Mobile", component: TechSlideMobile },
  // DTOP
  { id: "tech-divider-dtop", label: "▸ Layer 4 · DTOP", component: TechSlideLayerDivider, dividerProps: dividerProps.dtop },
  { id: "tech-slide-5", label: "L4 · DTOP", component: TechSlide5DTOP },
