...
const RegulationManagementPlaybook = () => {
  const [unlocked, setUnlocked] = useState(() => sessionStorage.getItem("rm-unlocked") === "true");
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (password === GATE_PASSWORD) {
      sessionStorage.setItem("rm-unlocked", "true");
      setUnlocked(true);
      setError(false);
    } else {
      setError(true);
      ...
      <div className="h-screen w-full bg-background flex items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl">Regulation Management Playbook</CardTitle>
