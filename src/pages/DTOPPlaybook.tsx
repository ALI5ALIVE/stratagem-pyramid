...
const DTOPPlaybook = () => {
  const [unlocked, setUnlocked] = useState(() => sessionStorage.getItem("dtop-unlocked") === "true");
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (password === GATE_PASSWORD) {
      sessionStorage.setItem("dtop-unlocked", "true");
      setUnlocked(true);
      setError(false);
    } else {
      setError(true);
      ...
      <div className="h-screen w-full bg-background flex items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl">DTOP Operating Model Playbook</CardTitle>
