...
import { Download, Film, Mic, Clock, Palette, Info } from "lucide-react";
import {
...
import {
  ...
  ART_DIRECTION,
  OUT_OF_SCOPE,
} from "@/data/comply365ExplainerV1";

export default function Comply365ExplainerV1() {
  ...
  async function downloadDocx() {
    ...
    children.push(H("Script (v1)", DocxHeadingLevel.HEADING_2));
    ...
    children.push(H("Out of scope for v1", DocxHeadingLevel.HEADING_2));
    ...
    a.href = url;
    a.download = "Comply365-Explainer-v1.docx";
    a.click();
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
          <div>
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.22em] text-muted-foreground mb-3">
              <Film className="h-3 w-3" /> Editorial · Explainer brief
            </div>
        ...
        {/* Script */}
        <section className="mb-14">
          <h2 className="font-heading text-2xl mb-5">2 · Script (v1)</h2>
        ...
        {/* Storyboard */}
        <section className="mb-14">
          <h2 className="font-heading text-2xl mb-5">3 · Storyboard — 12 shots</h2>
        ...
        <section className="mb-14">
          <h2 className="font-heading text-2xl mb-5 flex items-center gap-2">
            <Palette className="h-5 w-5 text-primary" /> 4 · Art direction
          </h2>
          <div className="rounded-xl border border-border bg-card/30 divide-y divide-border/60">
            {ART_DIRECTION.map((a) => (
        ...
        <section className="mb-14">
          <h2 className="font-heading text-2xl mb-5 flex items-center gap-2">
            <Info className="h-5 w-5 text-amber-400" /> 5 · Out of scope for v1
          </h2>
