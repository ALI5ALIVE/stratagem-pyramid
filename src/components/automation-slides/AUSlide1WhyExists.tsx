...
import { whyItExists } from "@/data/automationPlaybook";
import { Boxes, Code2, GitMerge, Wrench, TrendingDown, Users } from "lucide-react";

const icons = [Boxes, Code2, GitMerge, Wrench, TrendingDown, Users];

const AUSlide1WhyExists = (props: SlideNarrationProps) => {
  return (
    <SlideContainer id="au-why" title="Why It Exists" subtitle={whyItExists.headline} slideNumber={1} {...props}>
...
export default AUSlide1WhyExists;
