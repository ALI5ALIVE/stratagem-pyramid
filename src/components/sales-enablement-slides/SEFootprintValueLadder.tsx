...
const rungs = [
  {
    ...
    cost: "Localised efficiency in one lane",
  ...
  },
  {
    ...
    cost: "Half-loop efficiency — one connection works",
  ...
  },
  {
    ...
    cost: "Full DTOP loop closes — change cycles compress",
  ...
  },
  {
    ...
    pct: 100,
    color: "bg-primary",
    cost: "Loop compounds — system learns from every cycle",
