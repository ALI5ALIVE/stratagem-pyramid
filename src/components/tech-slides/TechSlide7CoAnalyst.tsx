...
const TechSlide7CoAnalyst = ({ slideNumber, ...narrationProps }: Props) => (
  <SalesSlideContainer
    ...
    title="Layer 3 · Intelligence & Orchestration — Insights & Intelligence (Intelligence Layer)"
  ...
  >
    <div className="flex-1 flex flex-col gap-4 min-h-0">
      <div className="flex items-center justify-between gap-3">
        ...
        <DeepDiveLink to="/coanalyst" label="Intelligence Layer" returnTo="/pitch-technical" />
      </div>
      {/* Master message */}
