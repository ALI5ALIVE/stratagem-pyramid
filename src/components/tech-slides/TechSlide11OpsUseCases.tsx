      ...
      <div className="flex flex-col gap-3">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-sm font-semibold text-foreground truncate">{uc.label}</h3>
        ...
        <div className="bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/20 rounded-lg p-2 shrink-0">
          <p className="text-xs text-center text-foreground">
            <span className="font-semibold text-primary">Each operational use case follows the same DTOP pattern</span> — building familiarity and accelerating adoption across departments.
          </p>
        </div>
      </div>
    </SalesSlideContainer>
