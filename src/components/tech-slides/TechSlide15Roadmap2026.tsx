...
const phases = [
  ...
  },
  {
    ...
    items: [
      ...
      "📋 Platform Intelligence Rollout (Intelligence & Orchestration Layer)",
      ...
      "📋 Platform Automation Rollout (Intelligence & Orchestration Layer)",
    ],
  },
  {
    ...
    items: [
      "Platform Recommendations — Future Vision (Intelligence & Orchestration Layer)",
      ...
      "Continued Roll Out of Platform Intelligence (Intelligence & Orchestration Layer)",
      "Continued Roll Out of Platform Automation (Intelligence & Orchestration Layer)",
