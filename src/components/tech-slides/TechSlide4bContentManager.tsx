...
const TechSlide4bContentManager = ({ slideNumber, ...narrationProps }: Props) => (
  <SalesSlideContainer id="tech-slide-4b" title="ContentManager365 + CoAuthor" subtitle="Next Gen Operational Content Management — from manual revisions to intelligent document orchestration" slideNumber={slideNumber} {...narrationProps}>
