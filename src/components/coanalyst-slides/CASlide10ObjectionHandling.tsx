...
const objections = [
  {
    ...
    response: "Customer data is never used to train public AI models (OpenAI, Microsoft, or any third party). Intelligence Layer operates within a secure, isolated AI pipeline — customer data is visible only to that customer, never shared across clients, and never leaves the controlled environment. We provide full transparency on our AI data architecture and infrastructure guarantees.",
  },
  {
    objection: "Our safety team is building their own AI models",
    response: "Intelligence Layer complements internal AI projects, it doesn't compete with them. Every modern software platform embeds AI capabilities — Intelligence Layer is the aviation-specific intelligence layer your internal team shouldn't have to rebuild. We've invested seven figures in domain-specific training across 4,000+ categories, and ship new AI capabilities weekly. Your data science team's time is better spent on problems unique to your operation.",
  },
  {
    objection: "We're using Claude / ChatGPT on our own data",
    response: "Generic LLMs achieve only 30–40% accuracy at granular aviation categorization (4,000+ categories, 5 levels) and hallucinate. Intelligence Layer uses a hybrid AI architecture (ML models + LLMs) trained on millions of historic reports, delivering 90% accuracy. Generic AI does summarization — for the real work, it fails.",
  },
  {
    objection: "We can build this ourselves",
    response: "Replicating Intelligence Layer requires years of aviation domain R&D (7-figure investment since 2023), millions of historical reports for model training, specialized ML engineering, 4,000+ category taxonomy, and continuous validation. Most internal builds take 3–5 years and cost significantly more than deploying a proven platform.",
  },
  {
    objection: "This is just analytics / AI features",
    response: "Analytics tools visualize data you already have. Intelligence Layer creates new intelligence by enriching, structuring, and analyzing raw aviation data — surfacing patterns, hazards, and weakening controls that no dashboard or bolt-on feature can detect. It's a standalone intelligence platform, not a feature.",
  },
  {
    objection: "Why are you more expensive than competitors?",
    response: "Intelligence Layer is a standalone data intelligence platform, not an add-on to safety reporting. You're investing in an intelligence layer that analyzes data across all operational domains and delivers predictive capability no competitor offers.",
  },
  {
    objection: "How is this different from AI in other safety tools?",
    response: "Other tools' AI helps process individual reports faster — basic summarization and suggested categories. Intelligence Layer analyzes data across domains, detects cross-system patterns, and delivers four levels of intelligence from historical to predictive. It's the difference between a spell-checker and an intelligence analyst.",
  },
  {
    objection: "Our current reporting system already works",
    response: "Reporting systems capture and route events — they're workflow tools. Intelligence Layer sits above them as an intelligence layer, transforming captured data into insights. It doesn't replace your reporting system — it makes it intelligent.",
  },
];
