        ...
        <div className="flex flex-col justify-center">
          <div className="bg-primary/10 border border-primary/30 rounded-xl p-4">
            ...
            <p className="text-sm text-foreground leading-relaxed font-medium">
              ...
              <span className="text-primary">Intelligence Layer</span> is the intelligence layer within the Operational Performance Platform that transforms fragmented safety and operational data into actionable intelligence — enabling the shift from critical event management to critical control management.
            </p>
            <p className="text-xs text-muted-foreground mt-3 leading-relaxed">
              Unlike generic AI tools that hallucinate at granular aviation categorization, or competitor bolt-on AI features limited to basic summarization, Intelligence Layer delivers aviation-specific precision built on a hybrid AI architecture, millions of historic reports, and continuous R&D — powering the DTOP model across every operational domain.
            </p>
          </div>
        </div>
      </div>
