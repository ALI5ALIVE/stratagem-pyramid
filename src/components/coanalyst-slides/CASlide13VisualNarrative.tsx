...
const visuals = [
  ...
  },
  {
    ...
    purpose: "Position Intelligence Layer above operational systems",
    shows: "Bottom layer: operational systems (Safety Manager, flight ops, maintenance). Middle: Intelligence Layer intelligence layer. Top: insights, decisions, outcomes",
  ...
  },
  {
    ...
    title: "How Intelligence Layer Works",
  ...
  },
  {
    ...
    title: "Generic AI vs Intelligence Layer",
    purpose: "Differentiation comparison",
    shows: "Two columns: Generic AI capabilities (basic summarization, prompted Q&A) vs Intelligence Layer capabilities (domain precision, hazard detection, pattern recognition, control insights)",
  ...
  },
  {
    ...
    shows: "Example: Intelligence Layer detects a pattern across 50+ reports of hydraulic issues on a specific fleet type, identifies weakening maintenance controls, triggers review before a failure occurs",
  ...
  },
  {
    ...
    shows: "Core modules (bottom: Safety, Content, Training Manager 365) → Intelligence Layer intelligence layer (center) → DTOP model (middle) → Better controls (upper) → Business outcomes (top). Cross-domain data flows in, intelligence flows out",
