...
const outcomes = [
  ...
  },
  {
    ...
    signal: "Audit finding trend detected",
    action: "Proactive procedure update deployed",
    result: "40% fewer regulatory findings",
              ...
              <div className="space-y-2 flex-1">
                {[
                  ...
                  <div key={step.label} className="flex items-start gap-2">
                    <span className="text-xs font-bold text-muted-foreground/60 mt-0.5 shrink-0 w-10">{step.label}</span>
          ...
          <div className="p-4 rounded-lg border border-muted/20 bg-muted/5">
            ...
            <div className="flex items-center gap-3 mt-3">
              <div className="flex-1">
                <div className="text-xs text-muted-foreground mb-1.5">Before: 60% coordination</div>
              ...
              <div className="flex-1">
                <div className="text-xs text-muted-foreground mb-1.5">After: 70% improvement</div>
                <div className="h-3 rounded-full bg-muted/20 overflow-hidden">
