...
const agendaItems = [
  ...
  { num: 5, label: "Value Ladder", summary: "How value compounds with maturity" },
  { num: 6, label: "Customers", summary: "Real-world measurable outcomes" },
  { num: 7, label: "Line of Sight", summary: "Interactive ROI calculator" },
  { num: 8, label: "Scorecard", summary: "Balanced strategic perspectives" },
  { num: 9, label: "Performance Shift", summary: "Cost reduction bell curve" },
];

interface ValueSlide0TitleProps extends SlideNarrationProps {
  onNavigateToSlide?: (slideIndex: number) => void;
}

const ValueSlide0Title = ({
  onNavigateToSlide,
  isPlaying = false,
  isLoading = false,
  progress = 0,
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl w-full text-center space-y-4 sm:space-y-6">
        ...
        <div className="flex justify-center">
          <img src={complyLogo} alt="Comply365" className="h-10 sm:h-14 w-auto" />
        </div>
        ...
        <div className="pt-2 sm:pt-4 space-y-1">
          <p className="text-muted-foreground text-sm sm:text-base font-medium">
            Value & ROI Presentation
          </p>
          <p className="text-muted-foreground/60 text-xs sm:text-sm">February 2026</p>
        </div>
      </div>
...
export default ValueSlide0Title;
