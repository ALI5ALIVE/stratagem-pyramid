...
import { heroEyebrow, heroTitle, heroTagline, heroSubtitle, statusLabel } from "@/data/insightsPlaybook";

const IRSlide0Title = (_props: SlideNarrationProps) => {
  return (
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 lg:px-16 relative z-10">
        <div className="max-w-7xl w-full mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold leading-tight mb-4">
            <span className="title-accent">Platform-wide</span>
            <br />
            <span className="text-foreground">Insights & Recommendations</span>
          </h1>
