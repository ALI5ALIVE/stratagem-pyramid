...
import { personas } from "@/data/mobilePlaybook";
import { User, MessageSquareQuote } from "lucide-react";

const MOSlide8Personas = (props: SlideNarrationProps) => {
  ...
  return (
    <SlideContainer
      ...
      subtitle="Persona-tailored openers and key messages."
      slideNumber={8}
      {...props}
    >
        ...
        <div className="flex flex-col gap-2">
          {personas.map((p, i) => (
            ...
            >
              ...
              <p className="text-[10px] text-muted-foreground mt-1">{p.careAbout}</p>
            </button>
          ))}
        </div>
...
export default MOSlide8Personas;
