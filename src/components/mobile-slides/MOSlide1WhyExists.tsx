...
import { whyItExists } from "@/data/mobilePlaybook";
import { Shuffle, Brain, EyeOff, Layers, ShieldAlert, Unplug } from "lucide-react";

const icons = [Shuffle, Brain, EyeOff, Layers, ShieldAlert, Unplug];

const MOSlide1WhyExists = (props: SlideNarrationProps) => {
  return (
    <SlideContainer id="mo-why" title="Why It Exists" subtitle={whyItExists.headline} slideNumber={1} {...props}>
...
export default MOSlide1WhyExists;
