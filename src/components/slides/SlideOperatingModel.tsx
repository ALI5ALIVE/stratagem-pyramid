    ...
    >
      <div className="flex-1 flex flex-col gap-2 h-full overflow-hidden">
        ...
        <div className="bg-primary/15 border-2 border-primary/40 rounded-xl px-5 py-2.5 text-center">
          <p className="text-[10px] text-primary uppercase tracking-widest font-semibold mb-0.5">Master Line</p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-card/60 border border-border/50 rounded-lg px-3.5 py-2.5">
            <p className="text-[10px] text-primary uppercase tracking-wider font-semibold mb-0.5">Brand Promise</p>
            <p className="text-xs text-foreground leading-relaxed font-medium">
              Turn fragmented operational activity into connected performance.
            </p>
          </div>
          <div className="bg-card/60 border border-border/50 rounded-lg px-3.5 py-2.5">
            <p className="text-[10px] text-destructive uppercase tracking-wider font-semibold mb-0.5">The Problem We Solve</p>
        ...
        <div className="bg-accent/10 border border-accent/30 rounded-lg px-3 py-2">
          <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-semibold mb-1">Operating Model — DTOP</p>
        ...
        {/* Messaging Pillars */}
        <div>
          <p className="text-[10px] text-primary uppercase tracking-wider font-semibold mb-1.5">Messaging Pillars</p>
        ...
        <div>
          <p className="text-[10px] text-primary uppercase tracking-wider font-semibold mb-1.5">Persona Pillars</p>
            ...
            {personas.map((p) => {
              ...
              return (
                <div key={p.role} className="bg-card/60 border border-border/50 rounded-lg px-2.5 py-2 flex flex-col gap-0.5">
                  ...
                  <p className="text-[9px] text-foreground/70 leading-snug">{p.message}</p>
                </div>
              );
            })}
          </div>
