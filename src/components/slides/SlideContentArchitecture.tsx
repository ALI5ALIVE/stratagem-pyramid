      ...
      <div className="flex-1 flex flex-col gap-4 h-full overflow-hidden">
        ...
        <div className="bg-primary/10 border border-primary/30 rounded-xl px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-primary uppercase tracking-widest font-semibold mb-0.5">Anchor Asset</p>
          ...
          <div className="bg-card/60 border border-border/50 rounded-xl p-4 flex flex-col">
            ...
            <div className="space-y-2 flex-1">
              {contentPrinciples.map((principle) => (
                <div key={principle} className="flex items-center gap-2.5 bg-background/50 rounded-lg px-3 py-2.5">
                  ...
                  <span className="text-xs text-foreground/80 font-medium">{principle}</span>
                </div>
              ))}
            </div>
            ...
            <div className="mt-auto pt-3 border-t border-border/30">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Thought Leadership</p>
              </div>
              ...
              <div className="space-y-1">
                {thoughtLeadershipGoals.map((goal, i) => (
                  <div key={i} className="flex items-start gap-1.5">
                    <span className="text-xs text-indigo-400 font-bold mt-0.5">{i + 1}.</span>
                    <span className="text-xs text-foreground/70 leading-snug">{goal}</span>
                  </div>
                ))}
              </div>
            </div>
