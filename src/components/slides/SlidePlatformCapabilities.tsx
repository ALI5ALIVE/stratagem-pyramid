...
const capabilityTimings = [
  { index: 0, startPercent: 15 },  // Data That Connects - "First: Data That Connects"
  { index: 1, startPercent: 38 },  // Automation That Adapts - "Second: Automation"
  { index: 2, startPercent: 58 },  // AI That Drives - "Third: AI That Drives"
];
