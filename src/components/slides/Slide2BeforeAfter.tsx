          ...
          <div className="relative bg-card border border-primary/30 rounded-xl p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-xs text-muted-foreground">Operational Performance Platform</span>
              </div>
            </div>
      ...
      <div className="mt-3 max-w-4xl mx-auto">
        <div className="bg-card border border-primary/30 rounded-xl p-5">
          <p className="text-sm text-muted-foreground">
            ...
            Comply365 connects all three into a connected, intelligent, and predictive platform — turning signals into orchestrated change and audit-ready proof.
          </p>
        </div>
      </div>
    </SlideContainer>
