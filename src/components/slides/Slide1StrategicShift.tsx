...
import { ArrowRight, AlertTriangle, FileText, GraduationCap, Shield, XCircle, Target, Zap } from "lucide-react";
...
const Slide1StrategicShift = () => {
  ...
  const whatThisIsNot = [
    { text: "A safety reporting tool", icon: Shield },
    { text: "A document/content management system", icon: FileText },
    { text: "A training LMS", icon: GraduationCap },
    { text: '"AI features" bolted on', icon: Zap },
    { text: "A single-function compliance solution", icon: Target },
  ];
  ...
  return (
    ...
    >
      {/* Category Promise Banner */}
      <div className="mb-8 bg-gradient-to-r from-primary/20 via-accent/10 to-primary/20 border border-primary/40 rounded-xl p-6 text-center">
        <p className="text-sm uppercase tracking-widest text-primary/80 mb-2">Category Promise</p>
        <p className="text-xl md:text-2xl font-bold text-foreground">
          Make operational excellence and readiness{" "}
          <span className="text-primary">predictable</span>,{" "}
          <span className="text-primary">measurable</span>, and{" "}
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-card/30 border border-destructive/30 rounded-xl p-5">
              ...
              {whatThisIsNot.map((item, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Icon className="w-4 h-4 text-destructive/60 shrink-0" />
        ...
        <div className="space-y-6">
          ...
          {/* The Opportunity */}
          <div className="bg-gradient-to-br from-amber-500/10 via-primary/10 to-emerald-500/10 border border-primary/30 rounded-xl p-5">
            <h3 className="text-base font-semibold text-foreground mb-3">The Opportunity:</h3>
            <div className="flex items-center justify-between gap-2 text-sm">
              <span className="px-3 py-1.5 rounded-lg bg-amber-500/20 text-amber-400 font-medium">Detect</span>
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              <span className="px-3 py-1.5 rounded-lg bg-orange-500/20 text-orange-400 font-medium">Trigger</span>
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              <span className="px-3 py-1.5 rounded-lg bg-primary/20 text-primary font-medium">Orchestrate</span>
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              <span className="px-3 py-1.5 rounded-lg bg-emerald-500/20 text-emerald-400 font-medium">Prove</span>
            </div>
          </div>
          ...
          <div className="bg-primary/10 border border-primary/30 rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground italic">
              "A platform that connects safety, procedures, and training into a continuous improvement 
              operating system — improving operational excellence, readiness, and customer experience at scale."
            </p>
          </div>
        </div>
      </div>
