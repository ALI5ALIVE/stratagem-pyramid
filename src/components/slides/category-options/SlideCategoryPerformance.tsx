...
import { performanceData, platformCapabilities } from "./categoryOptionData";

const SlideCategoryPerformance = ({
  isPlaying = false,
  isLoading = false,
  progress = 0,
  hasCompleted = false,
  ...
  const { category, pointOfView, pillars, pros, cons, executiveRationale, categoryPromise } = performanceData;

  return (
    <SlideContainer
      id="slide-15"
      title="Category Option: Performance"
      subtitle="Measurable outcomes & KPIs positioning"
      variant="dark"
      slideNumber={15}
      isPlaying={isPlaying}
      isLoading={isLoading}
...
export default SlideCategoryPerformance;
