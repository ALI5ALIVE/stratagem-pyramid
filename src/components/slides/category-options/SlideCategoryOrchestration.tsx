...
import { orchestrationData, platformCapabilities } from "./categoryOptionData";

const SlideCategoryOrchestration = ({
  isPlaying = false,
  isLoading = false,
  progress = 0,
  hasCompleted = false,
  ...
  const { category, pointOfView, pillars, pros, cons, executiveRationale, categoryPromise } = orchestrationData;

  return (
    <SlideContainer
      id="slide-14"
      title="Category Option: Orchestration"
      subtitle="Coordination & workflow automation positioning"
      variant="dark"
      slideNumber={14}
      isPlaying={isPlaying}
      isLoading={isLoading}
...
export default SlideCategoryOrchestration;
