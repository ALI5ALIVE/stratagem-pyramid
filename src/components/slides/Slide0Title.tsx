...
const agendaItems = [
  ...
  { num: 15, label: "Content Inventory", summary: "Full annual production stack" },
  { num: 16, label: "Homepage Experience", summary: "Category positioning in the product" },
  { num: 17, label: "Next Steps", summary: "Your path forward" },
];
