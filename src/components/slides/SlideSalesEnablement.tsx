      ...
      <div className="flex-1 flex flex-col gap-4 h-full overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-2 gap-4 overflow-hidden">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold px-1">Recommended Enablement Content</p>
                ...
                return (
                  <div key={asset.label} className="bg-card/60 border border-border/40 rounded-lg px-4 py-3 flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-snug mt-0.5">{asset.description}</p>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="flex flex-col gap-2">
            <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold px-1">What It Should Make Easier to Explain</p>
