...
const PFSlide12Closing = (props: SlideNarrationProps) => {
  return (
    <SlideContainer
      id="pf-closing"
      ...
      <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-3">
          <div className="p-3 rounded-lg border border-primary/30 bg-primary/5">
            <p className="text-[10px] uppercase tracking-wider text-primary mb-1">Master Elevator Pitch</p>
          ...
          <div className="p-3 rounded-lg border border-amber-500/30 bg-amber-500/5">
            ...
            <ul className="space-y-2">
              {discoveryQuestions.map((q, i) => (
                <li key={i} className="text-xs text-foreground/90 leading-relaxed">• {q}</li>
              ))}
            </ul>
          </div>
...
export default PFSlide12Closing;
