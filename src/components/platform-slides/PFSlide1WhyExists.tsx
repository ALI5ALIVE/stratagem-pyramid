...
const PFSlide1WhyExists = (props: SlideNarrationProps) => {
  return (
    <SlideContainer id="pf-why" title="Why It Exists" subtitle={whyItExists.headline} slideNumber={1} {...props}>
...
export default PFSlide1WhyExists;
