...
const DTOPSlide6UseCase3 = (props: SlideNarrationProps) => {
  return (
    <SlideContainer id="dtop-uc3" title={`DTOP in Action: ${uc.title}`} subtitle={uc.scenario} slideNumber={6} {...props}>
...
export default DTOPSlide6UseCase3;
