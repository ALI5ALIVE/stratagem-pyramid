...
const DTOPSlide4UseCase1 = (props: SlideNarrationProps) => {
  return (
    <SlideContainer id="dtop-uc1" title={`DTOP in Action: ${uc.title}`} subtitle={uc.scenario} slideNumber={4} {...props}>
...
export default DTOPSlide4UseCase1;
