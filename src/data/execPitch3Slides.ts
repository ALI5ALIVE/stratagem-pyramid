...
export const execPitch3Slides = [
  ...
  { id: "exec3-slide-coanalyst", label: "CoAnalyst", component: TechV4Slide7CoAnalyst, buyerFocus: "~90% domain accuracy at L4–5 vs ~35% generic AI — push on how that's measured" },
  { id: "exec3-slide-tiers-vs-ai", label: "CoAnalyst vs Generic AI", component: TechV4SlideTiersVsAI, buyerFocus: "why generic AI fails on aviation context — proof, not claims" },
