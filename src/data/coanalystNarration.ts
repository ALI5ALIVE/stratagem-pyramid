...
export const coanalystNarrations: CoAnalystNarration[] = [
  ...
  },
  {
    ...
    voiceId: DEFAULT_VOICE_ID,
    script: `Every sales conversation surfaces objections. Here are the strategic responses. When they say we are using ChatGPT on our own data, respond: generic models lack aviation taxonomy training and degrade at deep classification levels. When they say this is just analytics, clarify: analytics shows you dashboards. CoAnalyst creates the intelligence that makes those dashboards meaningful. When they say we will build it internally, ask: how many years of aviation AI training data do you have? CoAnalyst represents a seven-figure investment in domain-specific models you cannot replicate cost-effectively. When they say we are not ready for AI, reframe: CoAnalyst is not an AI experiment. It is a production-grade intelligence engine already processing millions of records at tier-one airlines.`,
  },
  {
    slideId: 11,
