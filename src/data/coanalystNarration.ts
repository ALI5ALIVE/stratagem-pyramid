...
export const coanalystNarrations: CoAnalystNarration[] = [
  ...
  },
  {
    ...
    title: "How It Works",
    voiceId: DEFAULT_VOICE_ID,
    script: `Intelligence Layer delivers four levels of intelligence, from hindsight to foresight. Historical intelligence answers the question: what happened? It lets you query past events across years of data. Reactive intelligence answers: what is happening now? Real-time alerts and situational awareness. Proactive intelligence asks: what should we watch? Pattern detection and emerging hazard indicators that surface before incidents occur. And predictive intelligence answers: what is likely next? Likelihood modelling and forward-looking risk assessment. Intelligence Layer is the intelligence layer that sits above operational systems. Other systems execute workflows. Intelligence Layer enriches, structures, analyses, and activates the data that powers them.`,
  },
  {
    slideId: 7,
    title: "Business Outcomes",
    voiceId: DEFAULT_VOICE_ID,
    script: `Intelligence is only valuable if it connects to measurable business outcomes. Intelligence Layer delivers across four dimensions. Time savings: analysts spend seventy percent less time on manual classification and report processing. Precision: over ninety percent accuracy in hazard classification means fewer missed risks and fewer false positives. Risk detection: cross-domain pattern analysis identifies emerging threats that siloed systems cannot see. And operational visibility: leadership gets a connected view of safety, compliance, and operational performance in real time. One safety director described it simply: Intelligence Layer gave us the ability to see what we were missing. That is the business case. Not just efficiency, but intelligence that changes decisions.`,
  },
  {
    slideId: 8,
    title: "vs Generic AI",
    voiceId: DEFAULT_VOICE_ID,
    script: `The comparison with generic AI is stark. At surface level, general-purpose models like ChatGPT or Claude can summarise text and answer questions. But aviation intelligence requires depth. At level one and two categorisation, generic models perform adequately, around seventy to eighty percent accuracy. But at levels four and five, where taxonomy-specific classification matters most, generic accuracy drops to thirty to forty percent. Intelligence Layer maintains over ninety percent accuracy at every level. The build versus buy argument is equally compelling. Intelligence Layer represents years of domain-specific investment: curated aviation training data, regulatory framework mapping, hybrid model architecture, and continuous learning from production deployments. No airline R and D team can replicate this in-house cost-effectively.`,
  },
  {
    slideId: 9,
    title: "Persona Messaging",
    voiceId: DEFAULT_VOICE_ID,
    script: `Different stakeholders need different messages. Safety leaders care about hazard detection accuracy and regulatory confidence. Tell them Intelligence Layer turns their safety data into predictive intelligence that regulators trust. Operations leaders care about efficiency and connected oversight. Show them how Intelligence Layer eliminates manual classification and surfaces cross-domain patterns. Maintenance and engineering teams want technical depth and integration. Demonstrate the hybrid architecture and API connectivity. Airline executives want strategic value and competitive advantage. Frame Intelligence Layer as the intelligence capability that differentiates their safety culture. And innovation leaders want scalability and future-readiness. Position Intelligence Layer as the AI foundation that grows smarter with every data point.`,
  },
  {
    slideId: 10,
    title: "Objection Handling",
    voiceId: DEFAULT_VOICE_ID,
    script: `Every sales conversation surfaces objections. Here are the strategic responses. When they say their AI policy restricts external AI software, respond: customer data is never used to train public AI models from OpenAI, Microsoft, or any third party. Intelligence Layer operates within a secure, isolated pipeline. Customer data is visible only to that customer, never shared across clients, and never leaves the controlled environment. We provide full transparency on our AI data architecture. When they say their safety team is building their own AI models, clarify: Intelligence Layer complements internal AI projects, it does not compete with them. We have invested seven figures in domain-specific training across four thousand categories and ship new capabilities weekly. Their data science team's time is better spent on problems unique to their operation. When they say we are using ChatGPT on our own data, respond: generic models lack aviation taxonomy training and degrade at deep classification levels. When they say this is just analytics, clarify: analytics shows you dashboards. Intelligence Layer creates the intelligence that makes those dashboards meaningful. When they say we will build it internally, ask: how many years of aviation AI training data do you have? Intelligence Layer represents a seven-figure investment in domain-specific models you cannot replicate cost-effectively.`,
  },
  {
    slideId: 11,
    title: "Taglines & Lines",
    voiceId: DEFAULT_VOICE_ID,
    script: `This slide provides ready-to-use positioning language across three categories. Taglines for brand-level messaging, like: The intelligence layer aviation has been missing. Or: From data noise to operational clarity. Homepage headlines for digital channels, such as: Your operations generate the data. Intelligence Layer generates the intelligence. And elevator pitches for conversations: Intelligence Layer is the AI intelligence engine inside the Comply three six five platform. It processes safety, operations, and compliance data with aviation-trained models to deliver the intelligence that generic AI cannot. Every tagline, headline, and pitch ladders back to the master message: From reports to intelligence. From events to control.`,
  },
  {
    slideId: 12,
    title: "Website Messaging",
    voiceId: DEFAULT_VOICE_ID,
    script: `This slide provides ready-to-use copy for the Intelligence Layer product page. The hero section leads with the intelligence gap: Your operations generate millions of data points. Intelligence Layer turns them into intelligence. The value proposition section reinforces the four tiers from historical to predictive. The how it works section walks through the pipeline: ingest from any source, enrich with aviation-trained AI, deliver structured intelligence. The differentiators section highlights what makes Intelligence Layer unique: hybrid architecture, domain training, production-proven accuracy. And the call to action drives toward a discovery conversation: See how Intelligence Layer transforms your operational data into intelligence that changes decisions.`,
  },
  {
    slideId: 13,
    title: "Visual Narrative",
    voiceId: DEFAULT_VOICE_ID,
    script: `The visual narrative system defines seven concept designs that support Intelligence Layer positioning across all channels. The industry shift visual shows the move from compliance to performance. The platform architecture shows Intelligence Layer sitting above the three product modules. The intelligence pipeline illustrates the data flow from ingestion through enrichment to intelligence tiers. The maturity levels visual maps the four intelligence tiers from historical to predictive. The AI comparison contrasts Intelligence Layer accuracy against generic models. The outcomes visual connects intelligence to measurable business results. And the master architecture brings everything together in a single connected view. These visuals should be consistent across presentations, website, collateral, and sales materials.`,
  },
  {
    slideId: 14,
    title: "Deck Structure",
    voiceId: DEFAULT_VOICE_ID,
    script: `The recommended positioning deck follows a ten-slide structure. Open with the industry shift to establish urgency. Present the intelligence gap to define the problem. Introduce Intelligence Layer as the solution with the platform architecture. Walk through the four intelligence tiers. Show the comparison against generic AI. Present business outcomes with real metrics. Address the audience with persona-specific messaging. Close with a clear next step. The key strategic decisions are clear. Intelligence Layer is positioned as an intelligence layer, not a standalone product. The narrative leads with the problem, not the technology. And every message ladders back to measurable operational outcomes. This playbook gives every team the tools to tell the Intelligence Layer story consistently and compellingly.`,
  },
];
