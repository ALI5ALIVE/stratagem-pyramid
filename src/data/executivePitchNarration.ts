...
export const exec3PitchNarrations: ExecNarrationSlide[] = [
  ...
  },
  {
    ...
    voiceId: DEFAULT_VOICE_ID,
    script:
      "This is the layer that separates a connected platform from a smart one. Two capabilities sit here — automation that runs the workflows, and intelligence that lets your team ask anything in plain English and get a defensible answer, while continuously surfacing the patterns nobody had time to look for. Together, this is what turns your operational data into action — and into the outcomes we showed you up front. Let's start with automation.",
  },
  {
  ...
  },
  {
    ...
    voiceId: DEFAULT_VOICE_ID,
    script:
      "This capability is about one thing — when somebody in your business has a question, they get an answer they can act on, today. Right now, that loop is broken. Your COO asks a question on Monday, the BI team builds a report, and three weeks later the answer arrives after the operation has already moved on. We close that gap. Anyone — a duty manager, a safety lead, a chief pilot — types a question in plain English, in the platform, and in under a minute they get a cited answer with the source data, the reasoning, and the single next best step tied to that question. This is where the ninety percent versus thirty-five percent number lives in the real world. Unlike generic AI tools, which hallucinate the moment you ask them to classify aviation events at any depth, and unlike competitor bolt-on AI features that are limited to basic summarisation, our intelligence layer delivers aviation-specific precision built on a hybrid AI architecture, millions of historic operational reports, and continuous R&D. In plain terms — ask 'show me the bird-strike trend at our top three hubs over the last ninety days,' and you get the right answer with sources and the next best step, where a generic model would mis-classify the events and miss the cluster entirely. This is reactive intelligence — you ask, the platform answers — and it is live today on SafetyManager365, with content and training following. The next slide is what comes when your platform stops waiting to be asked.",
  },
  {
