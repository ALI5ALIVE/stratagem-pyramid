...
export const salesDeckNarration: SalesNarrationSlide[] = [
  ...
  },
  {
    ...
    text: "Every signal your operation generates has a price tag. A single go-around burns eight to twenty-five thousand dollars in fuel — but when Foqua links that trend to forty-seven specific pilots and retrains them within forty-eight hours, those events drop by seventy-eight percent. An aircraft-on-ground day costs your COO up to half a million dollars — but when a compliance gap is caught before it grounds the fleet, that cost never hits the books. A one percent fuel variance? That's five to twenty million a year on your CFO's P and L — and it traces back to specific crews and specific procedures your platform can target. A single regulatory finding can cost your CEO fifty thousand to two million dollars — but when a reg change cascades automatically to every affected person, the finding never happens. What you're seeing here connects these real operational events, through the measures your teams can move, all the way up to the outcomes your board measures. For a mid-size carrier, the total cost avoidance opportunity exceeds forty million dollars annually. And we can build this model with your numbers.",
  },
  {
